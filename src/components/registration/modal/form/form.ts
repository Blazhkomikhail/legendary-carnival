...
export class Form extends BaseComponent {
  ...
  constructor() {
    ...
    this.firstNameInput = new Input('text', ['modal__input', 'firstname-input']);
    this.lastNameInput = new Input('text', ['modal__input', 'lastname-input']);
    this.emailInput = new Input('email', ['modal__input', 'email-input']);
    ...
    this.cancelButton = new Button('Cancel', ['modal__cancel-btn']);

    this.cancelButton.element.addEventListener('click', this.closeModalWindow);
